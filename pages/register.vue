<template>
  <div class="p-4 sm:ml-64 mt-14 mx-auto flex items-center justify-center">
    <div
    ...
    >
      ...
      <p class="text-sm pt-3 font-normal text-gray-500 dark:text-gray-400">
      ...
      <div>
        ...
        <svg  aria-hidden="true"
              ...
              viewBox="0 0 96 96"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"><path fill="#617BFF" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"/></svg>
        -->
      </div>
    </div>
  </div>
